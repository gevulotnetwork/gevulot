...
For a more in-depth look at the network design see our [docs](https://docs.gevulot.com).

## UPDATE

The original Gevulot Devnet has been phased out in favor of [Gevulot Firestarter](https://www.gevulot.com/firestarter).

The Firestarter and the upcoming [ZkCloud](https://www.zkcloud.com/) are built on completely new architecture and hence this node implementation is not maintained anymore.
