...
//file stored in extension and correspond to node file path.
...
// Task output file stored in <Task Tx hash>/<VM path>
...
// AssetFile: Use to download the file asset associated to a Tx file.
#[derive(Clone, Debug, Default, Deserialize, Serialize, PartialEq)]
...
// Output: A file attached to a proof or verify Tx: Only downloaded on distant host. Nothing done on the host when the Tx has been executed.
